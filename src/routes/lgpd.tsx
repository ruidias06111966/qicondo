    ...
    <SiteLayout>
      ...
      <section className="mx-auto max-w-5xl px-4 md:px-8 pb-16 grid md:grid-cols-2 gap-5">
        {[
          ...
          { icon: Mail, title: "DPO acessível", desc: "Encarregado de dados disponível em dpo@condozap.app para qualquer solicitação." },
        ].map((b) => (
      ...
      <section className="mx-auto max-w-3xl px-4 md:px-8 pb-20">
        <div className="rounded-2xl border border-border bg-surface p-8">
          ...
          <div className="mt-6 pt-6 border-t border-border">
            ...
            <a href="mailto:dpo@condozap.app" className="text-primary font-bold text-lg hover:underline">dpo@condozap.app</a>
          </div>
        </div>
      </section>
    </SiteLayout>
