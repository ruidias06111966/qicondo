...
export const Route = createFileRoute("/privacidade")({
  head: () => ({
    meta: [
      { title: "Política de privacidade — QiCond" },
      { name: "description", content: "Como o QiCond coleta, usa e protege seus dados." },
    ],
  }),
    ...
    <SiteLayout>
      <article className="mx-auto max-w-3xl px-4 md:px-8 py-16">
        ...
        <div className="space-y-5 text-sm text-muted-foreground leading-relaxed">
          <p>
            O QiCond respeita a sua privacidade e segue rigorosamente a Lei Geral de Proteção de
            Dados (Lei 13.709/2018).
          </p>

          <h2 className="font-display font-extrabold text-2xl text-foreground mt-10">
            1. Quais dados coletamos
          </h2>
          <ul className="list-disc pl-5 space-y-1.5">
            <li>
              <strong className="text-foreground">Síndicos:</strong> nome, email, telefone, CPF,
              dados do condomínio.
            </li>
            <li>
              <strong className="text-foreground">Moradores:</strong> nome, unidade, telefone (com
              opt-in para WhatsApp), email opcional.
            </li>
            <li>
              <strong className="text-foreground">Financeiros:</strong> taxas, pagamentos, despesas,
              comprovantes.
            </li>
            <li>
              <strong className="text-foreground">Técnicos:</strong> IP, navegador, logs de acesso.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5">
            <li>
              Provedores de infraestrutura (AWS, Supabase) — sob contrato de confidencialidade.
            </li>
            <li>
              Gateways de pagamento (Asaas, Iugu) — apenas dados necessários para a transação.
            </li>
          ...
          <p>
            Mantemos os dados enquanto a conta estiver ativa. Após o encerramento, os dados são
            excluídos em até 60 dias, exceto quando obrigados por lei a manter.
          </p>
          ...
          <p>
            <a href="mailto:qidomino@gmail.com" className="text-primary font-semibold">
              qidomino@gmail.com
            </a>
          </p>
        </div>
