...
export const Route = createFileRoute("/privacidade")({
  head: () => ({ meta: [{ title: "Política de privacidade — QiCond" }, { name: "description", content: "Como o QiCond coleta, usa e protege seus dados." }] }),
    ...
    <SiteLayout>
      <article className="mx-auto max-w-3xl px-4 md:px-8 py-16">
        ...
        <div className="space-y-5 text-sm text-muted-foreground leading-relaxed">
          <p>O QiCond respeita a sua privacidade e segue rigorosamente a Lei Geral de Proteção de Dados (Lei 13.709/2018).</p>
