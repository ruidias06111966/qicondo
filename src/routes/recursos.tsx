  ...
  head: () => ({
    meta: [
      { title: "Recursos — QiCond" },
      {
        name: "description",
        content:
          "Conheça todos os módulos do QiCond: cobrança, assembleias, reservas, encomendas, ocorrências e mais.",
      },
...
const blocks = [
  {
    ...
    items: [
      "Mural de avisos com confirmação de leitura",
      "Mensagens em massa segmentadas",
      "Templates aprovados pela Meta",
      "Bot conversacional com comandos",
    ],
  },
  {
    icon: PieChart,
    ...
    items: [
      "Geração de PIX e boleto registrado",
      "Cálculo de multa, juros e correção",
      "Acordo de parcelamento",
      "Fundo de reserva separado",
      "Exportação OFX para o contador",
    ],
  },
  {
    icon: Calendar,
    ...
    items: [
      "Reserva direto no WhatsApp",
      "Taxa, antecedência e horários por área",
  ...
  },
  {
    ...
    items: [
      "Foto e remetente da encomenda",
      "Notificação WhatsApp instantânea",
      "QR Code para visitantes",
      "Lista de visitantes recorrentes",
  ...
  },
  {
    ...
    items: [
      ...
      "Atribuição a zelador ou terceirizado",
  ...
  },
  {
    ...
    items: [
      "Um voto por unidade (anti-fraude)",
      "Quórum configurável",
      "Ata em PDF assinado eletronicamente",
  ...
  },
  {
    ...
    items: [
      ...
      "Múltiplos contatos por unidade",
      "Histórico do morador",
      "LGPD: opt-in registrado",
    ],
  },
  {
    ...
    items: [
      ...
      "Painel separado para o contador",
      "Acesso multi-síndico",
    ],
  },
  {
    icon: ShieldCheck,
  ...
  },
  {
    ...
    items: [
      "Troca rápida entre condomínios",
    ...
    <SiteLayout>
      ...
      <section className="mx-auto max-w-7xl px-4 md:px-8 pb-16 grid md:grid-cols-2 lg:grid-cols-3 gap-5">
        {blocks.map((b) => (
          <article
            key={b.title}
            className="rounded-2xl border border-border bg-surface p-6 hover:shadow-[var(--shadow-card)] transition-all"
          >
            <div
              className={`h-12 w-12 rounded-xl flex items-center justify-center mb-4 ${
                b.color === "warning"
                  ? "bg-warning/15 text-[var(--color-warning-foreground)]"
      ...
      <section className="mx-auto max-w-5xl px-4 md:px-8 pb-20">
        <div className="rounded-3xl bg-gradient-brand text-white p-10 md:p-12 text-center">
          ...
          <Link
            to="/contato"
            className="mt-6 inline-flex items-center gap-2 rounded-lg bg-white text-primary px-6 py-3 text-sm font-bold hover:scale-[1.02] transition-transform"
          >
