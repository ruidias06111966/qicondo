    ...
    <SiteLayout>
      <section className="mx-auto max-w-4xl px-4 md:px-8 pt-16 pb-10 text-center">
        ...
        <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
          ...
          moradores que esquecem de pagar, grupo de WhatsApp uma bagunça e nenhum sistema do mercado
          que valesse o preço cobrado. Decidimos construir o que faltava.
        </p>
      </section>
        ...
        {[
          {
            icon: Target,
            title: "Nossa missão",
            desc: "Levar gestão profissional para condomínios de qualquer tamanho, com preço justo e sem complicação.",
          },
          {
            icon: Heart,
            title: "Nosso jeito",
            desc: "Construímos com simplicidade. Se o síndico precisa de manual, falhamos no design.",
          },
          {
            icon: Lightbulb,
            title: "Nossa visão",
            desc: "Que todo morador resolva sua vida no condomínio direto pelo WhatsApp, sem instalar nada.",
          },
          {
            icon: Users,
            title: "Nosso time",
            desc: "Engenheiros, designers e ex-síndicos espalhados pelo Brasil. 100% remoto.",
          },
        ].map((b) => (
      ...
      <section className="mx-auto max-w-3xl px-4 md:px-8 pb-20">
        <div className="rounded-2xl border border-border bg-surface p-8">
          ...
          <ul className="space-y-4 text-sm text-foreground leading-relaxed">
            <li>
              <strong>Transparência radical.</strong> Preço, dados e regras sempre visíveis. Sem
              letra miúda.
            </li>
            <li>
              <strong>Privacidade primeiro.</strong> Os dados do condomínio são do condomínio.
              Exportáveis a qualquer momento.
            </li>
            <li>
              <strong>WhatsApp oficial.</strong> Usamos a API homologada da Meta. Nada de gambiarra
              que pode banir o número.
            </li>
            <li>
              <strong>Suporte humano.</strong> Quando você precisar de gente, vai falar com gente —
              em português.
            </li>
          </ul>
        </div>
