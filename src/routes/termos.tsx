...
export const Route = createFileRoute("/termos")({
  head: () => ({ meta: [{ title: "Termos de uso — CONDOZAP" }, { name: "description", content: "Termos e condições de uso do CONDOZAP." }] }),
...
function TermosPage() {
  return (
    <LegalPage title="Termos de uso" updated="03 de maio de 2026">
      <p>Bem-vindo ao CONDOZAP. Ao usar nossos serviços, você concorda com estes termos. Leia com atenção.</p>
      ...
      <p>O CONDOZAP é uma plataforma SaaS de gestão para condomínios residenciais, integrada ao WhatsApp Business API. Oferecemos cobrança, comunicação, reservas, ocorrências e prestação de contas.</p>
      ...
      <p>O CONDOZAP é uma ferramenta de apoio à gestão. As decisões e responsabilidades legais permanecem com o síndico e o condomínio.</p>
      ...
      <h2>10. Contato</h2>
      <p>Dúvidas? Escreva para <a href="mailto:juridico@condozap.app" className="text-primary">juridico@condozap.app</a>.</p>
    </LegalPage>
  );
}
